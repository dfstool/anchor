...
class OverviewTableHeaderDFS extends Component<Props> {
  render() {
    const {
      stakedResources,
      supportedContracts,
    ...
    const balanceHeaders = tokens.map((token, index) => {
...
export default withTranslation('main')(OverviewTableHeaderDFS);
