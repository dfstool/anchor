...
import OverviewTableHeader from './Table/HeaderDFS';
...
import GlobalAccountFragmentVoterInfoVotesDFS from '../../../../shared/containers/Global/Account/Fragment/VoterInfo/VotesDFS';
...
import GlobalAccountFragmentVoterInfoWeightValueDFS from '../../../../shared/containers/Global/Account/Fragment/VoterInfo/WeightValueDFS';
import GlobalAccountFragmentVoterInfoProxy from '../../../../shared/containers/Global/Account/Fragment/VoterInfo/Proxy';

class OverviewTableDFS extends Component<Props> {
  render() {
    const {
      chainSymbol,
      settings,
      ...
      tokens.forEach((token) => {
        ...
        if (chain === settings.chainId) {
          ...
          accountBalances[accountName].push((
            <Table.Cell textAlign="right" key={accountName+contract}>
...
export default withTranslation('main')(OverviewTableDFS);
