  ...
  switch (action.type) {
    ...
    case types.VALIDATE_NODE_SUCCESS: {
      ...
      return Object.assign({}, state, dfuseSettings, {
        ...
        chain: (blockchain && blockchain.name) || 'DFS Mainnet',
        chainId: (action.payload.info) ? action.payload.info.chain_id : settings.chainId,
        chainKey: (blockchain && blockchain._id) || 'dfs-mainnet',
        chainRamSymbol: (blockchain && blockchain.chainRamSymbol) || ((blockchain && blockchain.symbol) || 'DFS'),
        chainSymbol: (blockchain && blockchain.symbol) || 'DFS',
        err,
        greymassFuel: settings.greymassFuel,
        httpEndpoint: action.payload.node,
        keyPrefix: (blockchain && blockchain.keyPrefix) || 'DFS',
